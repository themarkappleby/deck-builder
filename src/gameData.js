  ...
  },
  {
    ...
    level1: {
      ...
      actions: [
        ...
        { type: 'attack', value: 5, description: 'Attacks for 5 damage' },
        { type: 'breath', value: 8, description: 'Dragon Breath: 8 damage (ignores 2 block)' },
        { type: 'attack', value: 4, description: 'Attacks for 4 damage' }
      ]
    },
    level2: {
      ...
      actions: [
        ...
        { type: 'attack', value: 3, description: 'Attacks for 3 damage' },
        { type: 'attack', value: 6, description: 'Attacks for 6 damage' },
        { type: 'breath', value: 10, description: 'Dragon Breath: 10 damage (ignores 3 block)' },
        { type: 'attack', value: 5, description: 'Attacks for 5 damage' }
      ]
    },
    level3: {
      ...
      actions: [
        { type: 'attack', value: 6, description: 'Attacks for 6 damage' },
        { type: 'attack', value: 8, description: 'Attacks for 8 damage' },
        { type: 'attack', value: 4, description: 'Attacks for 4 damage' },
        { type: 'attack', value: 7, description: 'Attacks for 7 damage' },
        { type: 'breath', value: 12, description: 'Dragon Breath: 12 damage (ignores 4 block)' },
        { type: 'attack', value: 6, description: 'Attacks for 6 damage' }
      ]
    }
  }
